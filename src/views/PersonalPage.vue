				...
				<div class="personal-card card mb-4">
					...
					>
						<div class="border-end">
							<img
								class="head-pic"
								:src="getPictureUrl(info.headshot)"
							/>
						</div>
						<div class="ms-3">
							<h6>{{ info.name }}</h6>
						...
						<template v-else>
							<button
								type="button"
								class="btn btn-light ms-auto me-3 py-1"
								@click="is_follow = !is_follow"
							>
								取消追蹤
							</button>
				...
				>
					<div class="card-header bg-transparent pt-3 border-0">
						<div class="d-flex align-items-center">
							<img
								:src="getPictureUrl(info.headshot)"
								class="headshot rounded-circle border"
							/>
